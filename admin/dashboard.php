					...
					<ul class="nav nav-primary">
						...
						<!-- <li class="nav-item">
							...
							<div class="collapse" id="admin">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=admin&act=add ">
											<span class="sub-item"> Tambah Admin </span>
										</a>
									</li>
									<li>
										<a href="?page=admin">
											<span class="sub-item"> Daftar Admiin </span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#wakel">
								<i class="fas fa-user-tie"></i>
								<p>Data Wali Kelas</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="wakel">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=wakel">
											<span class="sub-item"> Daftar Wali Kelas </span>
										</a>
									</li>
								</ul>
							</div>
...
<li class="nav-item">
							...
							<div class="collapse" id="staff">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=staff&act=add ">
											<span class="sub-item"> Tambah Staff </span>
										</a>
									</li>
									<li>
										<a href="?page=staff">
											<span class="sub-item"> Daftar Staff </span>
										</a>
									</li>
								</ul>
							</div>
						</li>
						<!-- absen guru dan staff -->
						<li class="nav-item">
							<a data-toggle="collapse" href="#absen">
								<i class="fas fa-user-friends"></i>
								<p>Absen Guru dan Staff</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="absen">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=absen&act=absenguru">
											<span class="sub-item"> Absen Guru </span>
										</a>
									</li>
									<li>
										<a href="?page=absen&act=absenstaff">
											<span class="sub-item"> Absen Staff </span>
										</a>
									</li>
								</ul>
							</div>
							...
							<div class="collapse" id="rekapabsen">
								<ul class="nav nav-collapse">
									<li>
										...
										<a href="?page=rekapabsen&act=rekapabsenguru">
											<span class="sub-item">Rekap Absen Guru </span>
										</a>
									</li>
									<li>
								
										<a href="?page=rekapabsen&act=rekapabsengurusemester">
											<span class="sub-item">Rekap Absen Guru <br> Per Semester </span>
										</a>
									</li>
									<li>
										<a href="?page=rekapabsen&act=rekapabsenstaff">
											<span class="sub-item">Rekap Absen Staff </span>
										</a>
									</li>
									<li>
										<a href="?page=rekapabsen&act=rekapabsenstaffsemester">
											<span class="sub-item">Rekap Absen Staff <br> Per Semester </span>
										</a>
									</li>
								</ul>
							</div>
...
if ($page == 'master') {
    ...
    } elseif ($act == 'rekap-perbulan') {  // Pastikan operator ==
    ...
    if ($act == '') {
        include 'modul/staff/data.php';
    } elseif ($act == 'add') {
        include 'modul/staff/add.php';
    } elseif ($act == 'edit') {
        include 'modul/staff/edit.php';
    } elseif ($act == 'del') {
        include 'modul/staff/del.php';
    } elseif ($act == 'proses') {
        include 'modul/staff/proses.php';
    }
} elseif ($page == 'absen') {
    if ($act == 'absenguru') {
        include 'modul/absensi/absenguru.php';
	}elseif ($act=='update') {
			include 'modul/absensi/updateguru.php';	
    } elseif ($act == 'absenstaff') {
        include 'modul/absensi/absenstaff.php';
    }elseif ($act=='updatestaff') {
		include 'modul/absensi/updatestaff.php';	
	}
} elseif ($page == 'rekapabsen') {
    if ($act == 'rekapabsenguru') {
        include 'modul/rekapabsen/rekapabsenguru.php';
	} elseif ($act == 'rekapabsengurusemester') {
		include 'modul/rekapabsen/rekapabsengurusemester.php';
    } elseif ($act == 'rekapabsenstaff') {
        include 'modul/rekapabsen/rekapabsenstaff.php';
    } elseif ($act == 'rekapabsenstaffsemester') 
		include 'modul/rekapabsen/rekapabsenstaffsemester.php';
} elseif ($page == '') {
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Sistem Informasi Absensi Siswa SMK GALUNGGUNG (<a>Cep Akil Fikraattausi </a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
