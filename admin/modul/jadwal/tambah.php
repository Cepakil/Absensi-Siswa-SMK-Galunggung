            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="kode" type="text" class="form-control" id="kode" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="mapel" class="form-control" onchange="updateKodePelajaran(this.value)">
                                        <option value="">- Pilih -</option>
                                        <?php 
                                        $mapel = mysqli_query($con,"SELECT * FROM tb_master_mapel ORDER BY id_mapel ASC");
                                        foreach ($mapel as $g) {
                                            echo "<option value='$g[id_mapel]' data-kode='$g[kode_mapel]'>[ $g[kode_mapel] ] $g[mapel]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                    ...
                    if (isset($_POST['save'])) {
                        ...
                        $guru = $_POST['guru'];
                        $mapel = $_POST['mapel'];
                        $hari = isset($_POST['hari']) ? implode(", ", $_POST['hari']) : ''; // Gabungkan hari menjadi satu string
                        $kelas = $_POST['kelas'];   
                        $waktu = $_POST['waktu'];
                        $jamke = $_POST['jamke'];

                        $insert = mysqli_query($con,"INSERT INTO tb_mengajar (hari, jam_mengajar, jamke, id_guru, id_mapel, id_mkelas, id_semester, id_thajaran) 
                            VALUES ('$hari', '$waktu', '$jamke', '$guru', '$mapel', '$kelas', '$semester', '$ta')");
...
<script type="text/javascript">
    ...
    function updateKodePelajaran(idMapel) {
        var selectedOption = document.querySelector('option[value="' + idMapel + '"]');
        var kodePelajaran = selectedOption.getAttribute('data-kode');
        document.getElementById('kode').value = kodePelajaran;
    }
</script>
