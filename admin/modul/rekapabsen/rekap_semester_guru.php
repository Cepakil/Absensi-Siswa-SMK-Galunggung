...
<head>
    ...
    <title>Rekap Absensi Guru - Semester <?= $semester ?> Tahun Ajaran <?= $tahun_ajaran ?></title>
        ...
        <tr>
            ...
            <td>
                <center>
                    <h1>
                        <small>
                            <b>REKAP ABSENSI GURU <br> PER SEMESTER <br>
                            SMK GALUNGGUNG</b>
                        </small>
                    </h1>
    ...
    <table width="100%" border="1" cellpadding="2" style="border-collapse: collapse; margin-bottom: 50px;">
        ...
        foreach ($guru as $s) {
            ...
            for ($i = 1; $i <= $tglTerakhir; $i++) {
                ...
                WHERE DAY(tanggal)='$i' AND id_guru='$ds[id_guru]' AND MONTH(tanggal)='$bulan' AND id_semester = $id_semester AND id_thajaran IN (SELECT id_thajaran FROM tb_thajaran WHERE status=1)");
