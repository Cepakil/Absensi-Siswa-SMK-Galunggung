...
<div class="container">
    <div class="page-header text-center">
        <h4 class="page-title display-5 font-weight-bold" style="font-size: 2.2rem;">Rekap Absensi Staff Per Semester</h4>
    </div>

    <div class="row justify-content-center mt-5">
        <div class="col-md-8 col-lg-6 form-container">
            <form action="modul/rekapabsen/rekap_semester_staff.php" method="post" class="text-center">
