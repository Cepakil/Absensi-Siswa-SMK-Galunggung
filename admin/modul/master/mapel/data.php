            ...
            <div class="modal-body">
                <form action="" method="post" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <input name="kode" type="text" placeholder="Masukkan kode mapel .." class="form-control">
                    </div>
                    <div class="form-group">
                ...
                if (isset($_POST['save'])) {
                    ...
                    $save = mysqli_query($con, "INSERT INTO tb_master_mapel (kode_mapel, mapel) VALUES ('$kode_mapel', '$nama_mapel')");
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    if (isset($_POST['edit'])) {
                        ...
                        $update = mysqli_query($con, "UPDATE tb_master_mapel SET kode_mapel='$kode_mapel', mapel='$nama_mapel' WHERE id_mapel='$id_mapel'");
