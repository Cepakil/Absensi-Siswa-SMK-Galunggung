                    ...
                    <form action="?page=siswa&act=proses" method="post" enctype="multipart/form-data">
                        ...
                        <table cellpadding="3" style="font-weight: bold;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <input type="hidden" name="nama_lama" value="<?=$d['nama_orangtua'] ?>">
                                <td><input type="text" class="form-control" name="nama_orangtua" value="<?=$d['nama_orangtua'] ?>"></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="kelas">
                                        ...
                                        while($kelas=mysqli_fetch_array($sqlKelas)){
                                            $selected = ($kelas['id_mkelas'] == $d['id_mkelas']) ? 'selected' : '';
