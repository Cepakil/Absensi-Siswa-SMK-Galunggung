...
if (isset($_POST['saveGuru'])) {
    ...
    if (!empty($gambar)) {
        ...
        $ganti = mysqli_query($con, "UPDATE tb_guru SET foto='$gambar' WHERE id_guru='$id'");
    }
    $editGuru = mysqli_query($con, "UPDATE tb_guru SET nip='$nip', nama_guru='$nama', email='$email' WHERE id_guru='$id'");
