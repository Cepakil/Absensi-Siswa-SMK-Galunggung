								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
											<h3 class="text-small"><?=$data['nama_guru'] ?></h3>
				...
				<div class="sidebar-content">
					<div class="user">
						...
						<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
							<span style="font-size: 11.6px;"> <!-- Atur ukuran font sesuai kebutuhan -->
								<?=$data['nama_guru'] ?>
								<span class="user-level" style="font-size: 11px;"> <!-- Atur ukuran font NIP sesuai kebutuhan -->
									<?=$data['nip'] ?>
								</span>
        ...
        <ul class="nav nav-collapse">
            ...
            <li>
                <a href="?page=absen&pelajaran=<?=$dm['id_mengajar'] ?> ">
                    <span class="sub-item"><?=strtoupper($dm['nama_kelas']) . " - " . strtoupper($dm['mapel']) . " (" . strtoupper($dm['hari']) . ")"; ?></span>
                </a>
            </li>
            <?php } ?>
        </ul>
								...
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=rekap&pelajaran=<?=$dm['id_mengajar'] ?> ">
											<span class="sub-item"><?=strtoupper($dm['nama_kelas']) . " - " . strtoupper($dm['mapel']); ?></span>
										</a>
									</li>
									<?php } ?>
								</ul>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SMK Galunggung (<a href="index.php">Cep Akil Fikraattausi </a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
